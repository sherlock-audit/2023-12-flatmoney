...
library FlatcoinStructs {
    struct GlobalPositions {
        /// @notice Total collateral deposited for leverage trade positions
        uint256 marginDepositedTotal;
        /// @notice Average entry price of all positions
        uint256 averageEntryPrice;
        /// @notice The total size of leverage across all trades on entry
        /// @dev Not adjusted for profit and loss
